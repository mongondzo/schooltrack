...
class ScheduleRoutes {
    ...
    switch (settings.name) {
      case list:
        return MaterialPageRoute(
          builder: (_) => SchedulesPage(repository: notificationRepository),
        );
      ...
      case edit:
        ...
        return MaterialPageRoute(builder: (_) => EditSchedulePage(schedule: s));

      case details:
        final s = settings.arguments as ScheduleEntity?;
        if (s == null)
          return _errorRoute('details nécessite une ScheduleEntity.');
        return MaterialPageRoute(
  ...
  static MaterialPageRoute _errorRoute(String msg) => MaterialPageRoute(
    builder: (_) => Scaffold(
      body: Center(
        child: Text(
          '⚠️ Route error: $msg',
