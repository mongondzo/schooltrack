...
class SchedulesPage extends StatefulWidget {
  const SchedulesPage({super.key, required NotificationRepository repository});
  ...
  Future<void> _confirmDelete(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        content: Text('Supprimer "$subject" ?\nCette action est irréversible.'),
        actions: [
          TextButton(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.read<ScheduleBloc>().add(LoadSchedules()),
            tooltip: 'Actualiser',
          ),
        ],
      ),
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              ...
                              _FilterChip(
                                label: 'Tous',
                                isSelected: state.selectedClass == null,
                                onTap: () => bloc.filterByClass(null),
                              ),
                              ...
                              ...classes.map(
                                (c) => Padding(
                                  ...
                                  child: _FilterChip(
                                    label: c,
                                    isSelected: state.selectedClass == c,
                                    onTap: () => bloc.filterByClass(c),
                                  ),
                                ),
                              ),
                            ],
                          ...
                          children: byDay.entries.map((entry) {
                            return _DaySection(
                              ...
                              onTap: (s) => Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      ScheduleDetailsPage(schedule: s),
                                ),
                              ),
                              ...
                              onDelete: (s) =>
                                  _confirmDelete(context, s.id, s.subject),
                            );
                          }).toList(),
                        ),
                ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.blue : AppColors.fieldBg,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
