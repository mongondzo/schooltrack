// ============================================================
// FICHIER : presentation/routes/class_routes.dart
//
// RÔLE : Centralise les noms de routes et la navigation
// pour toute la feature Classes.
//
...
//
//   // Aller aux détails (passe la ClassEntity en argument)
//   Navigator.pushNamed(
//     context,
//     ClassRoutes.details,
//     arguments: maClassEntity,
//   );
// ============================================================
  ...
  static Route<dynamic>? generate(RouteSettings settings) {
    switch (settings.name) {
      ...
      case edit:
        ...
        if (entity == null) {
          return _errorRoute('ClassRoutes.edit nécessite une ClassEntity en argument.');
        }
        return MaterialPageRoute(
      ...
      case details:
        final entity = settings.arguments as ClassEntity?;
        if (entity == null) {
          return _errorRoute('ClassRoutes.details nécessite une ClassEntity en argument.');
        }
        return MaterialPageRoute(
