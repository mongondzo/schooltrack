// ============================================================
// FICHIER : data/models/class_model.dart
//
// RÔLE : Le modèle est une version "enrichie" de l'entité.
// Il sait comment :
//   1. Se convertir depuis un document Firestore (fromMap)
//   2. Se convertir vers un Map pour Firestore (toMap)
//   3. Se construire depuis une entité pure (fromEntity)
//
// ClassModel ÉTEND ClassEntity : il a donc tous ses champs,
// plus les méthodes de conversion Firestore.
// ============================================================
