// C'est ici qu'on parle directement à Firebase / Cloud Firestore.
// Le repository appellera ce datasource, jamais directement le BLoC ou l'UI.

// Principe : ce fichier est le seul endroit dans la feature qui connaît
// Firestore. Si on change de base de données, on ne modifie que ce fichier.
...
class StudentRemoteDataSourceImpl implements StudentRemoteDataSource {
  ...
  // -------------------------------------------------------------------------
  // Écoute en temps réel la liste des élèves (Stream = mise à jour auto)
  // Firestore notifie l'app dès qu'un document change dans la collection.
  // -------------------------------------------------------------------------
  @override
  Stream<List<StudentModel>> getStudents() {
  ...
  // Firestore ne supporte pas la recherche "contains" nativement,
  // donc on charge tout et on filtre côté client.
  // Pour des milliers d'élèves, il faudrait utiliser Algolia ou Typesense.
  @override
